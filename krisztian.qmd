...
<div class="terminal" role="region" aria-label="Terminal demonstration - empty prompt" tabindex="0"><span class="prompt" aria-hidden="true">/demo $ </span><span class="cursor" aria-hidden="true"></span></div>
  </div>
...
<div class="top-bottom-layout">
  <div class="top-content">
<div class="terminal" role="region" aria-label="Terminal: Setup command" tabindex="0"><span class="prompt" aria-hidden="true">/demo $ </span><span class="command" aria-label="Command: Setup">: ⚙️ Setup</span><span class="cursor" aria-hidden="true"></span></div>
  </div>
